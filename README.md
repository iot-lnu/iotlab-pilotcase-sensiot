...
| Mifare RC522 RFID module   | <img src="img/rc522.png" width="100" height="70">      | [RC522](https://www.electrokit.com/rfid-modul-med-tva-tags-13.56mhz)        | The bridge between a microcontroller and RFID tags |
...
Other equipment that was investigated:
| Equipment                  | Component Image                                 | Reference                                                       | Function                                                                                                                                                           |
| -------------------------- | ----------------------------------------------- | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
